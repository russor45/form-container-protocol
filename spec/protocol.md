...
#### Before (Manual Responsive Handling)
...
{isMobile ? (
  <Sheet open={showSheet} onOpenChange={setShowSheet} side="bottom">
    <form onSubmit={handleSubmit}>...</form>
  </Sheet>
) : (
...
#### After (Unified Responsive Handling)

```typescript
const [isOpen, setIsOpen] = useState(false)
const position = useMediaQuery('(max-width: 768px)') ? 'bottom' : 'center'
...
- [Appendix A: Position Reference](spec/appendices/A-position-reference.md)
- [Appendix B: Implementation Examples](spec/appendices/B-implementation-examples.md)
- [Appendix C: Migration Guide](spec/appendices/C-migration-guide.md)
- [Appendix D: Common Patterns](spec/appendices/D-common-patterns.md)
- [Appendix E: Testing Guidelines](spec/appendices/E-testing-guidelines.md)
- [Appendix F: Mental Model](spec/appendices/F-mental-model.md)
- [Appendix G: Slot Contracts](spec/appendices/G-slot-contracts.md)
- [Appendix H: ARIA Mapping](spec/appendices/H-aria-mapping.md)